  ...
  render() {
    return (
      ...
      <div className="container">
        <h1 className="text-2xl flex-1 text-gray-700 text-center px-4 py-2 m-2">New Subscription</h1>
        <form className="w-full max-w-lg" onSubmit={this.onFormSubmit}>
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">
              ...
              <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="eg) Netflix" name="name" id="name" onChange={this.onInputChange}/>          
            </div>
          </div>
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">    
              <label className="text-xl block tracking-wide text-gray-700 text-xs font-bold mb-2 " for="payment-amount" htmlFor="payment_amount">Amount</label>
              <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="AUD" name="payment_amount" id="payment_amount" onChange={this.onInputChange}/>
            </div>
          </div> 
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">  
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">       
              ...
              <input className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded button-left" type="submit" value="CREATE" />
        </form>
      </div>
    );
  }
